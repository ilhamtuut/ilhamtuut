...
<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <td class="text-center">
            <a class="btn btn-info btn-xs" href="<?php echo site_url('produk/view/'.$produk->id_produk);?>"><span class="glyphicon glyphicon-eye-open"></span> view</a>
            <a class="btn btn-warning btn-xs" href="#modalEditProduk<?php echo $produk->id_produk;?>" data-toggle="modal">
                <span class="glyphicon glyphicon-edit"></span> Edit
            </a>
            <a class="btn btn-danger btn-xs" href="<?php echo site_url('produk/delete/'.$produk->id_produk);?>"onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini???')">
...
<div id="modalAddProduk" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form class="form-horizontal" method="post" action="<?php echo site_url('produk/tambah')?>" enctype="multipart/form-data">
...
<div id="modalEditProduk<?php echo $produk->id_produk?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('produk/update')?>" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Id</label>
                        <div class="col-sm-4">
