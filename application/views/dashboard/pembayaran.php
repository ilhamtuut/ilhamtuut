    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title"><span class="glyphicon glyphicon-edit"></span> Edit Cara Pembayaran</h3>
            </div>
            <form class="form-horizontal" method="post" action="<?php echo site_url('konten/update_bayar')?>">
                <div class="modal-body2">
                    ...
                    <div class="form-group">
                        <div class="form-group">
							<textarea name="cara_bayar"><?php echo $cara->cara_bayar;?> </textarea>
						</div> 
                    </div>
                </div>
